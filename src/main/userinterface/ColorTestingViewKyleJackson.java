 ...
 */
//==============================================================
public class ColorTestingViewKyleJackson extends View
{
    ...
    //----------------------------------------------------------
    public ColorTestingViewKyleJackson(IModel at)
    {
        super(at, "ColorTestingViewKyleJackson");
    ...
    private VBox createFormContent()
    {
        ...
        cancelButton.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent e) {
                clearErrorMessage();
                myModel.stateChangeRequest("CancelColorTesting", null);
            }
        });
