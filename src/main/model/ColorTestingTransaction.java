...
public class ColorTestingTransaction extends Transaction
{
     ...
     */
    //----------------------------------------------------------
    public ColorTestingTransaction() throws Exception
    {
        super();
    }
    ...
    protected void setDependencies()
    {
        ...
        dependencies.setProperty("CancelColorTesting", "CancelTransaction");
    ...
    {
        Scene currentScene = myViews.get("ColorTestingViewKyleJackson");

        if (currentScene == null)
        {
            // create our initial view
            View newView = ViewFactory.createView("ColorTestingViewKyleJackson", this);
            currentScene = new Scene(newView);
            myViews.put("ColorTestingViewKyleJackson", currentScene);
