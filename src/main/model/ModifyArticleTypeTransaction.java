...
public class ModifyArticleTypeTransaction extends Transaction {
    ...
    public Object getState(String key) {
        if (key.equals("ArticleTypeList") == true) {
            ...
            if (mySelectedArticleType != null)
                ...
                return "";
        } else if (key.equals("Description") == true) {
            if (mySelectedArticleType != null)
                return mySelectedArticleType.getState("Description");
            else
                return "";
        } else if (key.equals("AlphaCode") == true) {
            if (mySelectedArticleType != null)
    ...
    public void stateChangeRequest(String key, Object value) {
        ...
        if ((key.equals("DoYourJob") == true) || (key.equals("CancelArticleTypeList") == true) || (key.equals("CancelAddAT") == true)) {
            doYourJob();
        } else if (key.equals("SearchArticleType") == true) {
            processTransaction((Properties) value);
        } else if (key.equals("ArticleTypeSelected") == true) {
        ...
        } else if (key.equals("ArticleTypeData") == true) {
