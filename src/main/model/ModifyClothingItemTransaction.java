...
public class ModifyClothingItemTransaction extends Transaction
{
						...
						if (key.equals("Color2") == true)
						{
							...
							if (key.equals("Brand") == true)
							{
								...
								if (key.equals("ArticleType") == true)
								{
									...
									if (key.equals("DonorInformation") == true)
									{
										if (mySelectedClothingItem != null)
	...
	public void stateChangeRequest(String key, Object value)
	{
		...
		if ((key.equals("DoYourJob") == true) || (key.equals("CancelClothingItemList") == true))
		{
			...
			if (key.equals("SearchClothingItem") == true)
			{
	...
	{
		Scene currentScene = myViews.get("SearchClothingItemView");

		if (currentScene == null)
		{
			// create our initial view
			View newView = ViewFactory.createView("SearchClothingItemView", this);
			currentScene = new Scene(newView);
			myViews.put("SearchClothingItemView", currentScene);
